...
3. Each object must have: "startDate" and "endDate" (YYYY-MM-DD or string if variable), "holiday_name_en", "holiday_name_bn and "type" (if available, e.g., National, Religious).
...
6. Return a JSON object with three keys:
    ...
    - "holiday_name_en": string<Converted into Bangla>
